...
var $author$project$Entity$Key = {$: 'Key'};
...
var $author$project$Game$Map$iceLevels = function (_v0) {
	var x = _v0.a;
	var y = _v0.b;
	return _List_fromArray(
		[
...
var $author$project$Game$Map$lavaLevels = function (_v0) {
	var x = _v0.a;
	var y = _v0.b;
	return _List_fromArray(
		[
...
var $author$project$Game$Map$sokoBombLevels = function (_v0) {
	var x = _v0.a;
	var y = _v0.b;
	return _List_fromArray(
		[
...
var $author$project$Game$Map$dict = $elm$core$Dict$fromList(
	_Utils_ap(
		_List_fromArray(
			[
				_Utils_Tuple2(
		...
		_Utils_ap(
			$author$project$Game$Map$sokoBombLevels(
				_Utils_Tuple2(0, -1)),
			_Utils_ap(
				$author$project$Game$Map$lavaLevels(
					_Utils_Tuple2(2, -1)),
				$author$project$Game$Map$iceLevels(
					_Utils_Tuple2(4, -1))))));
...
var $author$project$Game$Map$getDoors = function (_v0) {
	var x = _v0.a;
	var y = _v0.b;
	return A2(
		$elm$core$List$filterMap,
		function (_v1) {
			var room = _v1.a;
			var pos = _v1.b;
			return A2($elm$core$Dict$member, room, $author$project$Game$Map$dict) ? $elm$core$Maybe$Just(
				_Utils_Tuple2(
					pos,
...
var $author$project$Game$Map$get = function (pos) {
	return A2(
		$author$project$Game$Build$fromBlocks,
		{
			doors: $author$project$Game$Map$getDoors(pos)
		},
		$elm$core$Dict$toList(
			A2(
				$elm$core$Maybe$withDefault,
				$elm$core$Dict$empty,
				A2($elm$core$Dict$get, pos, $author$project$Game$Map$dict))));
};
...
var $author$project$Main$init = function (_v0) {
	...
	var game = $author$project$Game$Map$get(room);
	return _Utils_Tuple2(
		{
			frame: 0,
			...
			room: room,
			seed: seed,
			unlockedRooms: $elm$core$Set$empty
		},
...
var $author$project$Game$Event$AddKey = {$: 'AddKey'};
...
var $author$project$Game$Event$UnlockDoor = {$: 'UnlockDoor'};
					...
					return $elm$core$Maybe$Just(
						{
							game: A2(
								...
								A2(
									$author$project$Game$move,
									{from: position, to: newLocation},
									A2($author$project$Game$remove, newLocation, game))),
							kill: _List_fromArray(
								[$author$project$Game$Event$AddKey])
						});
				case 'LockedDoor':
					var _v5 = _v0.a;
					return args.hasKey ? $elm$core$Maybe$Just(
						...
						$author$project$Game$Event$none(game));
				case 'Diamant':
					var _v6 = _v0.a;
					return $elm$core$Maybe$Just(
						{
...
var $author$project$Game$Update$updateCell = F3(
	function (args, _v0, game) {
		var position = _v0.a;
		var cell = _v0.b;
		var _v1 = cell.entity;
		switch (_v1.$) {
			...
			case 'Stunned':
				...
				return $author$project$Game$Event$none(
					A3(
						...
						game));
			case 'LockedDoor':
				return args.roomUnlocked ? $author$project$Game$Event$none(
					A2($author$project$Game$remove, position, game)) : $author$project$Game$Event$none(game);
			default:
				return $author$project$Game$Event$none(game);
		}
	});
var $author$project$Game$Update$updateGame = F2(
	function (args, game) {
		return A3(
			$elm$core$List$foldl,
			function (tuple) {
				return $author$project$Game$Event$andThen(
					A2($author$project$Game$Update$updateCell, args, tuple));
			},
			$author$project$Game$Event$none(
...
var $author$project$Main$startRoom = F2(
	function (game, model) {
		return _Utils_update(
			model,
			{
				game: (A2($elm$core$Dict$member, model.initialPlayerPos, game.floor) ? $elm$core$Basics$identity : A2($author$project$Game$addFloor, model.initialPlayerPos, $author$project$Entity$Ground))(
					A2(
...
var $author$project$Main$nextRoom = F2(
	function (room, model) {
		...
		return A2(
			...
			_Utils_update(
				model,
				{history: _List_Nil, initialPlayerPos: playerPos, room: room}));
	});
...
var $author$project$Game$Update$placeBombeAndUpdateGame = F3(
	function (args, playerCell, game) {
		return A2(
			$elm$core$Maybe$map,
			$author$project$Game$Update$updateGame(args),
			A2(
				$elm$core$Maybe$map,
									...
									A2(
										...
										function (playerPosition) {
											return A2(
												...
												A3(
													$author$project$Game$Update$placeBombeAndUpdateGame,
													{
														roomUnlocked: A2($elm$core$Set$member, model.room, model.unlockedRooms)
													},
													playerPosition,
													model.game));
										},
										...
										function (playerPosition) {
											return A2(
												...
												A2(
													...
													A3(
														$author$project$Game$Update$movePlayerInDirectionAndUpdateGame,
														{
															direction: dir,
															hasKey: model.hasKey,
															roomUnlocked: A2($elm$core$Set$member, model.room, model.unlockedRooms)
	...
	function (prefix, game) {
		...
		return A2(
			...
			function (_v0) {
				...
				return _Utils_Tuple2(
					prefix + ('_' + ($elm$core$String$fromInt(x) + $elm$core$String$fromInt(y))),
					_Utils_eq(y, -1) ? $author$project$View$Door$bottom(
						A2(
							$elm$core$List$cons,
							A2($elm$html$Html$Attributes$style, 'transform', 'rotate(-180deg)'),
...
var $author$project$View$Cell$bomb1 = function (attrs) {
	return A2(
		$author$project$View$Cell$fromEmojis,
		attrs,
		_List_fromArray(
...
var $author$project$View$Cell$bomb2 = function (attrs) {
	return A2(
		$author$project$View$Cell$fromEmojis,
		attrs,
		_List_fromArray(
...
var $author$project$View$Cell$key = function (attrs) {
	return A2(
		$author$project$View$Cell$fromEmojis,
		attrs,
		_List_fromArray(
...
var $author$project$View$Cell$lockedBottomDoor = function (attrs) {
	return A2(
		$author$project$View$Cell$fromEmojis,
		attrs,
		_List_fromArray(
...
var $author$project$View$Cell$wallDown = function (attrs) {
	return A2(
		$author$project$View$Cell$fromEmojis,
		attrs,
		_List_fromArray(
		...
		switch (cell.$) {
			...
			case 'InactiveBomb':
				return A2(
					...
					_Utils_Tuple2(1, 6));
			case 'ActiveSmallBomb':
				return (!args.frame) ? $author$project$View$Cell$bomb1(attrs) : $author$project$View$Cell$bomb2(attrs);
			case 'Enemy':
				var enemy = cell.a;
				return A2(
					$author$project$View$Cell$sprite,
			...
			case 'Wall':
				return (!_Utils_eq(
					A2(
						...
						_Utils_Tuple2(0, 1),
						args.neighborhood),
					$elm$core$Maybe$Just($author$project$Entity$Wall))) ? $author$project$View$Cell$wallDown(attrs) : $author$project$View$Cell$wall(attrs);
			case 'Diamant':
				return $author$project$View$Cell$diamant(attrs);
			case 'Key':
				return $author$project$View$Cell$key(attrs);
			default:
				return $author$project$View$Cell$lockedBottomDoor(attrs);
		}
	});
			...
			function (_v0) {
				...
				return _Utils_Tuple2(
					...
					A3(
						...
						{
							frame: args.frame,
							neighborhood: $elm$core$Dict$fromList(
								A2(
									$elm$core$List$filterMap,
									function (dir) {
										return A2(
